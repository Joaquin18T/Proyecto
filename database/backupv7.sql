...
(2,1,6,'2024-10-30 14:51:05',NULL),
(3,1,3,'2024-10-30 15:07:01',NULL),
(4,1,2,'2024-10-30 15:10:34',NULL),
(5,1,4,'2024-10-30 15:10:44',NULL),
(6,1,1,'2024-10-30 15:11:09',NULL);
...
insert  into `comentarios_odt`(`idcomentario`,`idorden_trabajo`,`comentario`,`revisadoPor`) values 
(1,1,'acabé',5);
...
(1,1,'2024-10-30 14:55:20','2024-10-30 14:55:21','00:00:01',11);
...
(1,1,1,'todas las tintas estaban vacias'),
(2,1,2,''),
(3,2,1,'');
...
insert  into `historial_odt`(`idhistorial`,`idorden_trabajo`) values 
(1,1);
...
insert  into `odt`(`idorden_trabajo`,`idtarea`,`creado_por`,`fecha_inicio`,`hora_inicio`,`fecha_vencimiento`,`hora_vencimiento`,`idestado`,`incompleto`,`eliminado`) values 
(1,1,5,'2024-10-30','14:51:00','0000-00-00','00:00:00',11,0,0),
(2,1,5,'2024-10-30','14:56:00','0000-00-00','00:00:00',9,1,0);
...
(1,'mantenimiento impresora',0,0,'2024-10-30 14:49:29','2024-10-30 15:11:46');
...
insert  into `tareas`(`idtarea`,`idplantarea`,`idtipo_prioridad`,`descripcion`,`idestado`,`trabajado`,`create_at`,`update_at`) values 
(1,1,4,'relleno de tintaxd',8,0,'2024-10-30 14:49:41','2024-10-30 14:58:10');
