...
(1,2,1,1,'14-EP','123ABC','2024-10-23','Laptop 14-EP 16 RAM','{\"ram\":\"16GB\", \"disco\":\"solido\"}'),
(2,10,1,1,'Monitor 4K','MON123','2024-10-23','Monitor LG de 27 pulgadas','{\"resolucion\":\"3840x2160\"}'),
(3,11,2,1,'Teclado Mecánico','TEC123','2024-10-23','Teclado mecánico HP','{\"tipo\":\"mecánico\", \"conectividad\":\"inalámbrico\"}'),
(4,7,4,1,'Compresor Industrial','COMP123','2024-10-23','Compresor Caterpillar de 10HP','{\"potencia\":\"10HP\"}'),
(5,6,5,1,'Camión de Carga Hyundai','CAM123','2024-10-23','Camión de carga pesada Hyundai','{\"capacidad\":\"10 toneladas\"}'),
(6,9,2,1,'L3110','IMP123','2024-10-23','Impresora HP L3110','{\"capacidad\":\"200 kilogramos\"}'),
...
(1,1,2,'0','2024-10-23',NULL,'En perfectas condiciones','{\"imagen1\":\"http://nose/que/poner\"}','equipo de trabajo',1,1),
(2,1,3,'0','2024-10-23',NULL,'Nuevo','{\"imagen1\":\"https://ejemplo.com/imagenes/lg_ultragear.jpg\"}','Asignación a usuario',6,1),
(3,2,4,'0','2024-10-23',NULL,'Este activo esta sin problemas','{\"imagen1\":\"https://ejemplo.com/imagenes/hp_pavilion.jpg\"}','Uso diario',1,1),
(4,3,5,'0','2024-10-23',NULL,'En buenas condiciones','{\"imagen1\":\"https://ejemplo.com/imagenes/caterpillar_320.jpg\"}','Asignación a proyecto',8,1),
...
(6,5,7,'0','2024-10-23',NULL,'Nuevo','{\"imagen1\":\"https://ejemplo.com/imagenes/hyundai_generator.jpg\"}','Generador de respaldo',12,1),
(7,6,8,'0','2024-10-23',NULL,'Nuevo','{\"imagen1\":\"https://ejemplo.com/imagenes/hp_laserjet.jpg\"}','Impresión de documentos',8,1),
(8,7,9,'0','2024-10-23',NULL,'Usado','{\"imagen1\":\"https://ejemplo.com/imagenes/lg_gram.jpg\"}','Laptop para administración',10,1),
(9,8,10,'0','2024-10-23',NULL,'Nuevo','{\"imagen1\":\"https://ejemplo.com/imagenes/abb_robot_irb.jpg\"}','Robot para automatización',14,1),
(10,9,11,'0','2024-10-23',NULL,'Usado','{\"imagen1\":\"https://ejemplo.com/imagenes/fenwick_forklift.jpg\"}','Montacargas para logística',14,1);
...
(1,1,5,'2024-10-23 14:53:59',NULL);
...
(1,2,3,'2024-10-23 14:53:59'),
(2,3,2,'2024-10-23 14:53:59'),
(3,4,1,'2024-10-23 14:53:59'),
(4,5,4,'2024-10-23 14:53:59'),
(5,6,2,'2024-10-23 14:53:59'),
(6,7,3,'2024-10-23 14:53:59'),
(7,8,4,'2024-10-23 14:53:59'),
(8,9,5,'2024-10-23 14:53:59'),
(9,10,2,'2024-10-23 14:53:59');
...
(1,'mantenimiento de impresora',0,1,'2024-10-23 14:53:59','2024-10-23 15:17:52'),
(2,'mantenimiento de laptop',1,0,'2024-10-23 15:18:04',NULL);
...
(1,2,1,'2024-10-23','pendiente','Para el proyecto X',1,NULL,NULL);
...
(1,1,3,'llenado de tinta color rojo','0000-00-00','0000-00-00',1,'mensual',1,'2024-10-23 14:53:59',NULL);
...
/* Procedure structure for procedure `sp_detalle_notificacion_resp` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_detalle_notificacion_resp` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_detalle_notificacion_resp`(
    IN _idusuario INT,
